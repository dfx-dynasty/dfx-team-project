...
export const DiligenceChecks = () => {
    return (
        <div id="diligence-check-card" className="p-4 mt-3">
            <h5 className="font-bold">Due Diligence Checks</h5>
            <div className="d-flex flex-wrap">
                ...
                <div className="widget-card d-flex align-items-center justify-content-between p-3 m-3">
                    <div className="d-flex align-items-center">
                        ...
                        <p className="font-small ms-3 mb-0">Disclosure</p>
                    </div>
                ...
                <div className="widget-card d-flex align-items-center justify-content-between p-3 m-3">
                    <div className="d-flex align-items-center">
                        ...
                        <p className="font-small ms-3 mb-0">Identity</p>
                    </div>
                    <i className="fa-regular fa-circle-check fa-xl diligence-check"></i>
                </div>
                <div className="widget-card d-flex align-items-center justify-content-between p-3 m-3">
                    <div className="d-flex align-items-center">
                        ...
                        <p className="font-small ms-3 mb-0">Credit</p>
                    </div>
                    <i className="fa-regular fa-circle-check fa-xl diligence-check"></i>
                </div>
                <div className="widget-card d-flex align-items-center justify-content-between p-3 m-3">
                    <div className="d-flex align-items-center">
                        ...
                        <p className="font-small ms-3 mb-0">Right to work</p>
                    </div>
                    <i className="fa-regular fa-circle-check fa-xl diligence-check"></i>
                </div>
                <div className="widget-card d-flex align-items-center justify-content-between p-3 m-3">
                    <div className="d-flex align-items-center">
                        ...
                        <p className="font-small ms-3 mb-0">Education</p>
                    </div>
                    <i className="fa-regular fa-circle-check fa-xl diligence-check"></i>
                </div>
            </div>
