...
export const Certifications = () => {
    return (
        <div id="certifications-card" className="p-4 mt-3">
            <h5 className="font-bold">Certifications <i className="fa-solid fa-circle-question question-icon ms-2"></i></h5>
            <div className="d-flex flex-wrap">
                ...
                <div className="widget-card d-flex align-content-center align-items-center p-3 m-3">
                    ...
                    <p className="font-small ms-3 mb-0">Certified Entry-Level Python Programmer</p>
                </div>
