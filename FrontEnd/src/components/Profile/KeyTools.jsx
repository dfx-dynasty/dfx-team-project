...
export const KeyTools = () => {
    return (
        <div id="key-tools-card" className="p-4 m-3">
            <h5>Key Tools <i class="fa-solid fa-circle-question question-icon ms-2"></i></h5>
            <div className="d-flex flex-wrap">
                {/* Next div is the one to map thorough */}
                <div className="widget-card d-flex p-3 m-3">
                    ...
                    <p className="ms-3 mb-0">Python</p>
                </div>
